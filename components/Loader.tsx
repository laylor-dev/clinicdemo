        ...
        >
          ...
          <div
            ...
            style={{
              width: '420px',
              height: '420px',
              background: 'radial-gradient(circle, rgba(179,140,97,0.12) 0%, transparent 70%)',
              filter: 'blur(40px)',
            }}
          />
          ...
          <div className="relative flex flex-col items-center gap-10">
            ...
            >
              <svg width="120" height="60" viewBox="0 0 74 37" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-[#eae8e8]">
              ...
              >
                <span className="font-sans text-[11px] uppercase tracking-[0.45em] text-[#eae8e8]/40">Aventura</span>
                <span className="font-serif italic text-[#eae8e8]/60 text-lg tracking-wide">Dental Arts</span>
              </motion.div>
            </motion.div>
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-32 h-px bg-white/10 overflow-hidden rounded-full">
            <motion.div
              className="h-full bg-[#b38c61] rounded-full"
              initial={{ width: '0%' }}
              animate={{ width: '100%' }}
